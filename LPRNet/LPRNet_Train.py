...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dirs_train', default="/datav/shared/dataset/CCPD2020/ccpd_green/train", help='the training images path')
    parser.add_argument('--img_dirs_val', default="/datav/shared/dataset/CCPD2020/ccpd_green/train", help='the validation images path')
